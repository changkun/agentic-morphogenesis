...
\Description{A roadmap-style diagram with twenty numbered phases connected by arrows. Phases 1 to 4 are colored teal for observed results, phases 5 to 8 orange for conjectured role extensions, phases 9 to 19 red for speculative ecosystem and self-reference dynamics, and phase 20 purple for the limiting claim that sustained morphogenesis is the attractor. A dotted arrow loops from phase 20 back to phase 1.}
\label{fig:teaser}
\end{teaserfigure}
