...
\Description{A long horizontal roadmap covering eight epochs and twenty phases. The first phases are marked as observed, the next set as conjectured, later ones as speculative, and the final phase as the limit claim. Arrows connect phases to show successive bottleneck-driven transitions.}
\label{fig:roadmap}
\end{figure*}
